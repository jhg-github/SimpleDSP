...
extern const float filter_coeffs_low[FILTER_COEFFS_LOW_NTAPS];    // lowpass filter
extern const float filter_coeffs_band[FILTER_COEFFS_BAND_NTAPS];  // bandpass filter
